                                    ...
                                    <div class="card User-Activity">
                                        ...
                                        <div class="card-block pb-0">
                                            <form class="link-form" action='{{ route('doctors.store') }}' method='POST' enctype="multipart/form-data">
                                                ...
                                                <input id='doctor-name' class='form-control' type='text' name='name' placeholder="Nombre" required>
                                                <input id='doctor-email' class='form-control mt-3' type='text' name='email' placeholder="Email" required>
                                                <input id='doctor-password' class='form-control mt-3' type='password' name='password' placeholder="Contraseña" required>
                                                <input class='form-control mt-3' type='text' name='specialty' placeholder="Especialización">
                                                <br>
