                                    ...
                                    <div class="card User-Activity">
                                        ...
                                        <div class="card-block pb-0">
                                            <form class="link-form" action='{{ route('doctors.update', $doctor->id) }}' method='POST' enctype="multipart/form-data">
                                                ...
                                                <input id='doctor-name' class='form-control' type='text' name='name' placeholder="Nombre" value='{{ $doctor->name }}'>
                                                <input class='form-control mt-3' type='text' name='specialty' placeholder="Especialización" value='{{ $doctor->doctor->specialty ?? '' }}'>
                                                <br>
