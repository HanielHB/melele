                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">Planificación</h5>
                                    </div>
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="feather icon-home"></i></a></li>
                                        <li class="breadcrumb-item"><a href="{{ route('appointments.index') }}">Planificaciónsz</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:">Planificación</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-block text-center">
                                            ...
                                            <div class="row m-t-50">
                                                ...
                                                <div class="col-md-4 col-lg-4">
                                                    ...
                                                    <span class="text-muted">Fecha final</span>
                                                </div>
                                            </div>
