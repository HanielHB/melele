                                    ...
                                    <div class="card User-Activity">
                                        ...
                                        <div class="card-block pb-0">
                                            <form class="link-form" action='{{ route('admins.store') }}' method='POST' enctype="multipart/form-data">
                                                ...
                                                <input id='admin-name' class='form-control' type='text' name='name' placeholder="Nombre" required>
                                                <input id='admin-email' class='form-control mt-3' type='text' name='email' placeholder="Email" required>
                                                <input id='admin-password' class='form-control mt-3' type='password' name='password' placeholder="Contraseña" required>
                                                <br>
