...
<head>
    ...
    <title>MeleleApp | Registrar</title>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-10">
                                    ...
                                    <form action="{{ route('signup') }}" method="post">
                                        ...
                                        <div class="input-group mb-4">
                                            <input type="password" class="form-control" name="password_confirmation" placeholder="Confimar Contraseña">
                                        </div>
                                        <button type="submit" class="btn btn-primary shadow-2 mb-4">Registrar</button>
                                    </form>
                                    <p class="mb-0 text-muted">¿Ya tienes una cuenta? Hacer <a href="{{ route('login') }}">
                                            login</a></p>
                                </div>
                            </div>
                        </div>
