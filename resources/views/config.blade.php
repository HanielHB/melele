                                    ...
                                    <div class="card User-Activity">
                                        ...
                                        <div class="card-block pb-0">
                                            <form class="link-form" action='{{ route('users.update', $user->id) }}' method='POST' enctype="multipart/form-data">
                                                ...
                                                <input id='user-name' class='form-control' type='text' name='name' placeholder="Nombre" value='{{ $user->name }}'>
                                                @if ($user->type === 'patient')
                                                    <input class='form-control mt-3' type='text' name='social' placeholder="CI" value='{{ $user->patient->social_number ?? '' }}'>
                                                    <div class="form-group mt-2">
                                                        <label for="blood-type">Grupo sanguíneo</label>
                                                ...
                                                @endif
                                                @if ($user->type === 'doctor')
                                                    <input class='form-control mt-3' type='text' name='specialty' placeholder="Especialización" value='{{ $user->doctor->specialty ?? '' }}'>
                                                @endif
                                                <br>
