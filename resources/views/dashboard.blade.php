                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card shadow-sm">
                                        <div class="card-block customer-visitor">
                                            ...
                                            <i class="material-icons text-c-blue">Hoy</i>
                                        </div>
                                    </div>
                                </div>
                                <!--[ card-dash ] end-->
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card shadow-sm">
                                        <div class="card-block customer-visitor">
                                            ...
                                            <span class="text-right d-block h5">Marcado</span>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card shadow-sm">
                                        <div class="card-block customer-visitor">
                                            ...
                                            <i class="material-icons text-c-blue">Horario</i>
                                        </div>
                                    </div>
                                </div>
                                <!--[ card-dash ] end-->
                                            ...
                                            <div class="card-block pb-0">
                                                ...
                                                @if ($user->type === 'patient')
                                                    <a href="{{ route('appointments.index') }}" class="btn btn-outline-primary" style="width: 100%; margin-bottom: 20px;">
                                                        <i class="feather icon-plus-circle"></i>Programar cita
                                                    </a>
                                                @endif
                                            </div>
                                        </div>
