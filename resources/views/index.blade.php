...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>MeleleApp | Agendamiento de Consultas Online</title>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="{{ route('index') }}"> <img src="{{ asset('img/landing/logo.png') }}" alt="logo"/>
                                     MeleleApp
                            </a>
                    ...
                    <div class="col-lg-5 col-xl-5">
                        <div class="banner_text">
                            <div class="banner_text_iner">
                                ...
                                <h1>Mejores Doctores</h1>
                                <p>Aquí en MedMazza encontrarás a los mejores médicos de la región, con un servicio diferenciado y una programación muy fácil.</p>
                                <a href="{{ route('login') }}" class="btn_2">Programe su Consulta</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7">
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-md-6 col-lg-5">
                        <div class="about_us_text">
                            ...
                            <p>Nuestro principal objetivo es que nuestros pacientes encuentren al médico y programe una cita de la manera más fácil posible. Este viaje Tiene que ser agradable, así que siempre estamos dispuestos a ayudar. </p>
                        ...
                        <div class="single_feature">
                            <div class="single_feature_part">
                                <span class="single_feature_icon"><img src="{{ asset('img/landing/children.png') }}"
                                        alt=""></span>
                                <h4>Pediatria</h4>
                                <p>Nuestra misión es ofrecer apoyo preventivo, para que los niños, niñas y adolescentes Crecer sano y feliz.</p>
                            </div>
                        </div>
                        <div class="single_feature">
                            <div class="single_feature_part">
                                <span class="single_feature_icon"><img src="{{ asset('img/landing/heart.png') }}"
                                        alt=""></span>
                                <h4>Cardiología</h4>
                                <p>Nuestros cardiólogos están altamente cualificados identificar las enfermedades de una de las principales órganos del cuerpo humano.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="single_feature">
                            <div class="single_feature_part">
                                <span class="single_feature_icon"><img src="{{ asset('img/landing/eye.png') }}"
                                        alt=""></span>
                                <h4>Oftalmología</h4>
                                <p>Cuidado de enfermedades que afectan a los ojos y Los cursos de visión son impartidos por nuestros oftalmólogos.</p>
                            </div>
                        </div>
                        <div class="single_feature">
                            <div class="single_feature_part">
                                <span class="single_feature_icon"><img src="{{ asset('img/landing/bone.png') }}"
                                        alt=""></span>
                                <h4>Ortopedia</h4>
                                <p>Nuestros ortopedistas se encargaron de sus huesos, músculos, articulaciones, ligamentos y otros componentes de su sistema.</p>
                            </div>
                        </div>
                    </div>
                </div>
